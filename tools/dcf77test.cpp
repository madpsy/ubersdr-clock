...
// the way main.cpp consumes a decoder: a `time` event composed against the last
...
Result run(const Scenario& sc) {
    ...
    // measurement, and nothing downstream uses an edge that early (main.cpp
